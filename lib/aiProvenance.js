...
function buildAiInteractionRecord(opts) {
  ...
  /** Full assessment pipeline applies every suggestion to the project; mirror “selected” UX in history. */
  let selections = [];
  if (markAllSuggestionsApplied && Array.isArray(suggestions) && suggestions.length > 0) {
