...
// Local password/login has been removed for security hardening.
router.all('/local*', (req, res) => {
  res.status(410).json({
    message: 'Local login/password authentication has been removed. Use organisation SSO.',
  });
});
